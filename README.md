...
## v22
- Usunięto fałszywy komunikat o braku JS.
- Podgląd (nie-admin): ukryta edycja i masowe funkcje.
- Paczka pod GitHub Pages: tylko index.html/app.js/style.css (+README).
